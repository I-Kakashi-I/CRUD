...
<h1 class=" text-center mb-xl-5">
    <span class="text-primary">Update Task</span>
    <br>
</h1>
<br>
<section>
        ...
        <div class="row justify-content-center">
            <div class="col-md-9 col-lg-8 col-xl-6">
                <div class="text-center mb-4">
                    <form class="" action="../controllers/updateTasks.php" method="POST">
                        <input type="hidden" value="<?= $tasks['id'] ?>" name="task_id" id="id">
