...
<h1 class=" text-center mb-xl-5">
    <span class="text-primary">Add New Role</span>
    <br>
</h1>
<br>
<section>
        ...
        <div class="row justify-content-center">
            <div class="col-md-9 col-lg-8 col-xl-6">
                <div class="text-center mb-4">
                    <form class="" action="../controllers/addRoles.php" method="POST">
                        <?php include './extra/alert.php' ?>
                        <div class="col-12">
                            <label for="inputEmail4" class="form-label">Role Name</label>
                            <input type="text" class="form-control" name="role_name" id="task_name">
                        </div>
