      ...
      <div class="row justify-content-center">
        <div class="col-md-9 col-lg-8 col-xl-6">
          ...
          <div class="text-center mb-4">
            <form class="row g-1" action = "../controllers/controller1.php" method = "POST">
                ...
                <div class="col-12">
                    ...
                    <div class="input-group mb-3" id="eye">
                        <input class="form-control password block" id="password" class="block mt-1 w-full"
                               type="password" name="password" value="" required/>
                        <span class="input-group-text togglePassword" >
                                    <span data-feather="eye" style="cursor: pointer"></span>
                                </span>
                    </div>
                </div>
                <br>
                ...
                <div class="col-12">
                    ...
                    <div class="input-group mb-3"  id="eye2">
                        <input class="form-control password2 block " id="confirm_password" class="block mt-1 w-full"
                               type="password" name="confirm_password" value="" required/>
                        <span class="input-group-text togglePassword2">
